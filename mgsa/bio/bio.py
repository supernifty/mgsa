...
class Config(object):
  '''
    ...
    * reports
    * bias_report_buckets
    * insertion_source: random (not implemented) random = randomly generated bases according to error profile
