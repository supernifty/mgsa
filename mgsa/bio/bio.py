...
class Config(object):
  '''
    ...
    * mutation_type
    * read_length
    * seed_length: length of seed used by mapper
    ...
    * call_strategy: consensus|aggressive specifies the strategy for predicting a variation. consensus = most reads predict the variation, aggressive = always call the variation
